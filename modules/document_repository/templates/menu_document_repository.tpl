            ...
            <form name = "uploadForm" id = "uploadForm" method = "POST" enctype="multipart/form-data" action="AjaxHelper.php?Module=document_repository&script=documentEditUpload.php">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-xs-12 form-group">
                            <label class="col-xs-4" for="version">Subject</label>
                            <div class="col-xs-8">
 								<select name="version" id = "version" class = "form-fields form-control input-sm">
                                <option value=""> </option>
                                    {foreach from = $version item=val key=k}
